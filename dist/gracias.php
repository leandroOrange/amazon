...
if (($_GET['ag']) === 'or') {
  ...
  $id_google_googletag_conversion = $orange->get('id-google-ads-conversion-orange');
}else{
  $id_google_tag = $orange->get('id-google-ads-thera');
  $id_google_analytics = $orange->get('id-google-analytics-thera');
  switch (($_GET['campaign'])) {
    case 'th-display':
      $id_google_googletag_conversion = $orange->get('id-google-ads-conversion-thera-display');
      break;
    case 'th-youtube':
      $id_google_googletag_conversion = $orange->get('id-google-ads-conversion-thera-youtube');
      break;
  }
